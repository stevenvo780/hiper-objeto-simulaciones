...
def fetch_urbanization(cache_path, country="WLD", start_year=1960, end_year=2022, refresh=False):
    ...
    if df.empty:
        raise RuntimeError("No se encontraron datos de urbanización para el rango solicitado")
